    ...
    var body: some View {
        ...
        ZStack {
            ...
            Circle()
                ...
                .stroke(Color.mainBlue, style: StrokeStyle(lineWidth: 24, lineCap: .round))
                .rotationEffect(.degrees(-90))
            
            // Interest Arc
            Circle()
                .trim(from: CGFloat(principalFraction), to: CGFloat(principalFraction + interestFraction))
                .stroke(Color.secondaryBlue, style: StrokeStyle(lineWidth: 24, lineCap: .round))
                .rotationEffect(.degrees(-90))
            
            // Fees Arc
            Circle()
                .trim(from: CGFloat(principalFraction + interestFraction), to: 1.0)
                .stroke(Color.alertRed, style: StrokeStyle(lineWidth: 24, lineCap: .round))
                .rotationEffect(.degrees(-90))
