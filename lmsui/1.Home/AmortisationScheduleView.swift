                ...
                Button {
                    ...
                    VStack(spacing: 6) {
                        ...
                        ZStack {
                            ...
                            Circle()
                                ...
                                .stroke(isSelected ? Color.white : Color.mainBlue, style: StrokeStyle(lineWidth: 5, lineCap: .round))
                                .frame(width: 34, height: 34)
                                .rotationEffect(.degrees(-90))
                            Circle()
                                .trim(from: principalFraction(month), to: 1)
                                .stroke(isSelected ? Color.white.opacity(0.5) : Color.alertRed.opacity(0.7), style: StrokeStyle(lineWidth: 5, lineCap: .round))
                                .frame(width: 34, height: 34)
                                .rotationEffect(.degrees(-90))
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12)
                            .fill(isSelected ? Color.mainBlue : (month.isPaid ? Color.lightBlue.opacity(0.5) : Color.white))
                    )
                    .shadow(color: isSelected ? Color.mainBlue.opacity(0.3) : .black.opacity(0.04), radius: isSelected ? 8 : 4, x: 0, y: 2)
                }
        ...
        VStack(spacing: 16) {
            ...
            GeometryReader { geo in
                ...
                HStack(spacing: 0) {
                    ...
                    RoundedRectangle(cornerRadius: 6)
                        .fill(Color.alertRed.opacity(0.7))
            ...
            HStack {
                VStack(alignment: .leading, spacing: 4) {
                    HStack(spacing: 6) {
                        Circle().fill(Color.mainBlue).frame(width: 8, height: 8)
                        Text("Principal")
